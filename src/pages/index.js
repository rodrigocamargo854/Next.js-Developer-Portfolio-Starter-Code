...
export default function Home() {
  return (
    <div className="dark:bg-slate-950">
      ...
      <main className="flex items-center justify-center flex-col dark:bg-slate-900 text-dark w-full min-h-screen sm:flex-row" >
        <Layout className="pt-0 bg-white dark:bg-slate-900 px-6 py-8 ring-1 ring-slate-900/5 shadow-xl">
